...
" fern.vim file explorer drawer
nmap <silent> <Leader>f :Fern . -drawer -toggle -width=35<CR>
nmap <silent> <Leader>F :Fern . -drawer -reveal=%<CR>

" Jump to the Rails files you open most. Split, then tab.
...
" Dynamic splits: the focused window grows, the rest shrink
set winwidth=84
set winheight=5
set winminheight=5
set winheight=999

" Relative line numbers, set on entering any buffer
autocmd BufEnter * set relativenumber

" Rename the file in the current buffer
function! RenameFile()
  let old_name = expand('%')
